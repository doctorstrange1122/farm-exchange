    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                view.loadData("<html><body style='padding:20px;text-align:center;'><h2>加载失败</h2><p>" + description + "</p><p>请检查网络连接后重试</p></body></html>", "text/html; charset=utf-8", "UTF-8");
            }
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        String filename = "farm_qrcode_" + System.currentTimeMillis() + ".png";
        ...
        public void copyToClipboard(final String text) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    ClipData clip = ClipData.newPlainText("farm", text);
        ...
        try {
            ...
            if (content == null) {
                ...
                if (html != null && !html.trim().isEmpty()) {
                    content = Html.fromHtml(html, Html.FROM_HTML_MODE_LEGACY).toString().trim();
                }
            }
